...
const allSkillsData = {
  'html-semantic-tags': {
    title: '語意化標籤',
    context: '此專案展示了如何正確使用 HTML5 語意化標籤來提升網頁的可讀性、SEO 和無障礙性。',
    techStack: ['HTML5', 'CSS3'],
  },
  'html-forms-validation': {
    title: '表單與原生驗證',
    context: '此專案展示了 HTML 表單的建立，以及如何利用 HTML5 原生驗證功能來提升使用者體驗和數據完整性。',
    techStack: ['HTML5', 'CSS3', 'JavaScript'],
  },
  'html-accessibility': {
    title: '無障礙網頁',
    context: '此專案展示了如何遵循 WCAG 指南，建立對所有使用者都友善的無障礙網頁。',
    techStack: ['HTML5', 'CSS3', 'ARIA'],
  },
  'css-pseudo-elements': {
    title: '偽類元素',
    context: '此專案展示了 CSS 偽類元素 (::before, ::after, :hover, :focus 等) 在網頁設計中的應用。',
    techStack: ['CSS3'],
  },
  'css-animations': {
    title: '動畫',
    context: '此專案展示了使用 CSS3 動畫和過渡效果來增強使用者介面互動性。',
    techStack: ['CSS3'],
  },
  'css-custom-properties': {
    title: '自訂屬性',
    context: '此專案展示了 CSS 自訂屬性 (CSS Variables) 的使用，以實現更靈活和可維護的樣式。',
    techStack: ['CSS3'],
  },
  'css-rwd': {
    title: 'RWD',
    context: '此專案展示了響應式網頁設計 (RWD) 的實現，確保網頁在不同設備上都能良好顯示。',
    techStack: ['CSS3', 'Media Queries'],
  },
  'javascript-event-listeners': {
    title: '監聽事件',
    context: '此專案展示了 JavaScript 事件監聽器在處理使用者互動方面的應用。',
    techStack: ['JavaScript'],
  },
  'javascript-async-await': {
    title: 'Async/Await',
    context: '此專案展示了使用 Async/Await 處理非同步操作，使程式碼更易讀和維護。',
    techStack: ['JavaScript (ES6+)'],
  },
  'javascript-es6-functions': {
    title: 'ES6+函式',
    context: '此專案展示了 ES6+ 中箭頭函數、解構賦值、展開運算符等新特性在函數編寫中的應用。',
    techStack: ['JavaScript (ES6+)'],
  },
  'vue-reactivity': {
    title: '響應式',
    context: '此專案展示了 Vue 3 響應式系統的工作原理，包括 ref 和 reactive 的使用。',
    techStack: ['Vue.js 3', 'Composition API'],
  },
  'vue-props-passing': {
    title: 'props傳遞',
    context: '此專案展示了 Vue 組件之間通過 props 進行數據傳遞的最佳實踐。',
    techStack: ['Vue.js 3'],
  },
  'vue-pinia': {
    title: 'Pinia',
    context: '此專案展示了使用 Pinia 進行 Vue 應用程式的狀態管理。',
