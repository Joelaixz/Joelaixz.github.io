...
<script setup>
// 此組件主要用於展示靜態內容，因此不需要額外的 JavaScript 邏輯
</script>
...
.about-photo img {
  ...
  border: 5px solid var(--primary-color); /* 邊框，來自 CSS 變數 */
}
...
.about-text p {
  ...
  font-size: 1.15rem; /* 放大字體大小 */
  text-indent: 2em; /* 段落開頭縮排兩個中文字體 */
}
